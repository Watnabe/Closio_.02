...
Class Message extends Model
{
    ...
    function save(){
        ...
        //if the message is being created for an object other than a deal, then the deal id will be retrieved from
        //the actual object
        //if the message is being posted on a deal, then the deal id is the messages reference_id
        if($this->reference_object != 'deal')
            $deal_id = isset($reference_object->deal_id) ? $reference_object->deal_id : false;
        else $deal_id = $this->reference_id;

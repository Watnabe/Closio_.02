...
$LANG['proposalList'] = array(
    ...
    'newProposalButton' => 'Proposal',
    'creatingproposalNotification' => 'Creating Proposal. Please wait'
);
...
$LANG['proposalView'] = array(
    ...
    'adminPreviewNotice' => 'This is how your client will see the proposal.',
    'adminPreviewNoticeClose' => 'Close Preview',
    'clientPreviewNotice' => 'to close the proposal preview.',
    'clientPreviewNoticeClose' => 'Click here',
    'proposalSent' => 'Proposal Sent',
    'deleteProposalButton' => 'Delete Proposal',
    'deleteProposalConfirmationMessage' => 'Are you sure you want to delete this proposal? This can not be undone.',
    'enterPayment' => 'Enter Payment',
    'confirmNavigation' => 'The proposal has not been saved. Are you sure you would like to leave this page?'
);

//proposal editor
$LANG['proposalEditor'] = array(
    'doneButton' => 'Done Editing Proposal',
    'saveButton' => 'Save &amp; Continue',
    'importTasksButton' => 'Import Tasks',
    'deleteButton' => 'Delete',
    'showCompetedTasks' => 'Show completed tasks',
    'editItemTitle' => 'Edit item',
    'deletItemTitle' => 'Delete item',
    'deleteConfirmationButton' => 'Delete Proposal',
    'deleteConfirmationMessage' => 'Are you sure you want to delete this proposal? This can not be undone.'
);

//proposal details
$LANG['proposalDetails'] = array(
    'number' => 'Proposal #',
    'dueDate' => 'Due Date',
    'status' => 'Status',
    'dateSent' => 'Date Sent',
...
$LANG['clientDetails'] = array(
    ...
    'dealName' => 'Name',
    'dealDueDate' => 'Due Date',
    'dealStatus' => 'Status',
    'userName' => 'Name',
    'userEmail' => 'Email',
    'proposalNumber' => 'Proposal #',
    'proposalTotal' => 'Total',
    'proposalBalance' => 'Balance',
    'proposalStatus' => 'Status',
    'proposalDueDate' => 'Due Date',
...
//client assign user to client view
$LANG['clientAssignUser'] = array(
    'title' => 'Assign User'
);
...
$LANG['dealForm'] = array(
    ...
    'newDeal' => 'New :type',
    'editDeal' => 'Edit :type',
    'dealCreated' => ':type created',
    'dealEdited' => ':type edited',
...
//deal progress title widget
$LANG['dealProgressTitleWidget'] = array(
    'title' => 'Deal progress',
);
...
//delete deal
$LANG['deleteDeal'] = array(
    'title' => 'Delete Deal',
    'message' => 'Are you sure you want to delete :name?',
    'button' => 'Delete deal',
    'secondaryTitle' => 'Delete Deal - Confirmation',
    'secondaryMessage' => 'This will also delete all files and tasks in ":name". Are you sure you would like to delete this deal?',
    'secondaryButton' => 'Yes, delete this deal',
    'inProgress' => 'Deleting deal'
);
...
$LANG['deleteClient'] = array(
    ...
    'secondaryMessage' => 'This will also delete all deals associated with ":name". Are you sure you would like to delete this client?',
...
$LANG['taskList'] = array(
    'noTasks' => 'There are no tasks for this deal. Start typing below to add one...'
);
...
//dashboard deal tiles
$LANG['dashboardDealTiles'] = array(
    'progress' => 'Progress',
    'expectedProgress' => 'Expected Progress',
    'dueDate' => 'Due Date',
);
...
//dashboard deal list
$LANG['dashboardDealList'] = array(
    'dueDate' => 'Due Date',
);

//deal notes
$LANG['dealNotes'] = array(
    'editNotes' => 'Edit Notes',
...
$LANG['adminSettings'] = array(
    ...
    'deletePaidproposalSection' => 'Delete Proposal',
    'deletePaidproposalInstructions' => 'Allows you to delete an proposal that has already been paid',
    'deletePaidproposal' => 'Delete Proposal'
);

$LANG['deleteproposal'] = array(
    'instructions' => 'Use this form to delete any proposal, even paid proposal.',
    'fieldLabel' => 'Proposal Number',
    'button' => 'Delete Proposal',
    'title' => 'Delete Proposal',
    'successNotification' => 'Proposal Deleted'
);
...
//new deal from template
$LANG['newDealFromTemplateForm'] = array(
    'title' => 'New Deal'
);
...
$LANG['reporting'] = array(
    ...
    'outstandingproposals' => 'Outstanding Proposals',
    'revenuePerClient' => 'Revenue Per Client',
    'payments' => 'Payments',
    'paymentDate' => 'Date',
    'paymentAmount' => 'Amount',
    'paymentClient' => 'Client',
    'paymentproposalNumber' => 'Proposal #',
    'paymentEndOfList' => 'end of list',
...
$LANG['email_subjects'] = array(
    ...
    'new_proposal' => "You've received an proposal from " . get_config('company.name'),
    ...
    'message' => "A message has been posted on a deal",
    'uploaded_file' => "A file has been uploaded to a deal",
...
$LANG['activity'] = array(
    ...
    'payment_created' => 'Proposal # :proposalNumber for :currencySymbol:paymentAmount',
    'due_date_updated_details' => 'The due date on :dealName has been :differenceDirection by :differenceInDays :daysText',
    'status_change' => 'Status change on',
    'status_change_details' => 'The status on :dealName changed to :dealStatus',
...
$LANG['errors'] = array(
    ...
    'task_invalid_deal' => 'Invalid deal id',
...
$LANG['payment'] = array(
    'description' => '#:proposalNumber: :currencySymbol:amount,  Payment made by :userFirstName :userLastName on :date'
);

...
This will generate the file `build/pdf.js` that can be included in your final deal. (WARNING: That's a large file! Consider minifying it).
...
pdf.js is a community-driven deal, so contributors are always welcome. 
...
If you don't want to hack on the deal or have little spare time, __you still
...
Gallery of user deals and modifications:

+ https://github.com/mozilla/pdf.js/wiki/Gallery-of-user-deals-and-modifications
